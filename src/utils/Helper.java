...
public class Helper {
    /**
     * This method checks whether a given string consists only of numeric digits (0-9).
     *
     * @param text The string to be checked.
     * @return {@code true} if the string contains only numeric digits, {@code false} otherwise.
     */
    ...
    /**
     * This method checks whether a given character represents a valid sex identifier ('M' or 'F').
     *
     * @param sex The character to be checked.
     * @return {@code true} if the character is 'M' or 'F', {@code false} otherwise.
     */
    public static boolean MFSexCheck(char sex){return (sex == 'M') || (sex == 'F');
    }
